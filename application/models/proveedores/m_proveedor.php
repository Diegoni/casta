...
class M_Proveedor extends MY_Model
{
	...
	function __construct()
	{
		...
		$this->_relations['descuentos'] = array (
			'ref'	=> 'catalogo/m_proveedoreditorial',
			'type'	=> DATA_MODEL_RELATION_1N,
			'fk'	=> 'nIdProveedor');

		parent::__construct('Prv_Proveedores', 'nIdProveedor', 'cEmpresa, cNombre, cApellido', array('cNombre', 'cApellido', 'cEmpresa'), $data_model, TRUE);
		$this->_cache = TRUE;
	}
