...
/**
 * Líneas de reclamación pedido proveedor
 *
 */
class M_reclamacionlinea extends MY_Model
{
	/**
	 * Constructor
	 * @return M_reclamacionlinea
	 */
	function __construct()
	{
		$obj = get_instance();
		$data_model = array(
			'nIdReclamacion'	=> array(DATA_MODEL_TYPE => DATA_MODEL_TYPE_INT, DATA_MODEL_REQUIRED => TRUE, DATA_MODEL_EDITOR => array(DATA_MODEL_EDITOR_COMBO, 'compras/reclamacion/search')),
		...
		parent::__construct('Doc_LineasReclamacionPedidoProveedor', 'nIdLinea', 'nIdLinea', 'nIdLinea', $data_model, TRUE);
	}
...
/* End of file M_reclamacionlinea.php */
/* Location: ./system/application/models/compras/M_reclamacionlinea.php */
