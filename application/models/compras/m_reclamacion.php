...
class M_reclamacion extends MY_Model {
    ...
    function __construct() {
        ...
        parent::__construct('Doc_ReclamacionesPedidoProveedor', 'nIdReclamacion', 'nIdReclamacion', 'nIdReclamacion', $data_model, TRUE);

        $this->_relations['lineas'] = array(
            'ref' => 'compras/m_reclamacionlinea',
            'cascade' => TRUE,
...
/* Location: ./system/application/models/compras/M_reclamacion.php */
