...
summary="<?php echo $this->lang->line('Artículos no consultados') . ' ' . $id;?>">
	<caption>
		<strong><?php echo $this->lang->line('Artículos no consultados') .' ' . $id;?></strong>
	</caption>
	<thead>
		<tr>
	...
	<tfoot>
		<tr>
			<td colspan="9" scope="row">
				<?php echo count($titulos);?> <?php echo $this->lang->line('registros encontrados');?>, 
