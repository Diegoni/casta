...
<div class="data">
		<h1 class="titulo">
			(<?php echo $editorial['nIdEditorial']; ?>) <?php echo $editorial['cNombre'];?>
		</h1>
</div>
...
<h2><?php echo $this->lang->line('Ventas');?></h2><hr/>

<div style="page-break-inside: avoid;">
	<h3><?php echo $this->lang->line('TOTAL');?></h3>
<table><tr><td>
...
foreach ($secciones as $sec => $v)
{
	...
	echo '</td><td>';
	show_table2($v, $this, $mes);
	echo '</td></tr></table>';
	echo '</div>';
	++$j;
}

function show_table2($totales, $lang, $mes)
{
?>
<div class="data">
	<table>
...
function show_data2($id, $totales, $anos, $mes)
{
	$t = '';
	foreach ($anos as $a) 
	{
...
$(function () {
	...
	<?php echo show_data2('totales', $totales, $anos, $mes); ?>
	<?php 
	$i = 0;
	foreach ($secciones as $sec => $v)
	{
		echo show_data2('sec_' . $i, $v, $anos, $mes);
		++$i;
	}
	?>
