...
<div style='page-break-after: always;'><?php $url= site_url("oltp/oltp/ventas_secciones/{$id}/{$fecha_url}");?>
...
<?php echo _vs_cabecera('Tipo', $this); ?> <?php if (isset($ventas[$anno])): ?>
<?php echo _vs_linea('Ventas' , $ventas[$anno], 'format_price'); ?> <?php endif; ?>
<?php if (isset($coste_ventas)): ?> <?php echo _vs_linea('Coste Ventas' , $coste_ventas[$anno], 'format_price'); ?>
<?php endif; ?> 
<?php if (isset($albaranes)): ?> <?php echo _vs_linea('Alb. sin fact.' , $albaranes[$anno], 'format_price'); ?>
<?php endif; ?> 
<?php if (isset($compras)): ?> <?php echo _vs_linea('Compras' , $compras, 'format_price'); ?>
<?php endif; ?> 
<?php if (isset($devoluciones)): ?>
	<?php echo _vs_linea($this->lang->line('Devoluciones') , $devoluciones, 'format_price'); ?>
<?php endif; ?> 
<?php if (isset($movsalida)): ?>
	<?php echo _vs_linea($this->lang->line('Mov.Salida') , $movsalida, 'format_price'); ?>
<?php endif; ?>
<?php if (isset($moventrada)): ?>
	<?php echo _vs_linea($this->lang->line('Mov.Entrada') , $moventrada, 'format_price'); ?>
<?php endif; ?>
<?php if (isset($diferencia)): ?>
	<?php echo _vs_linea($this->lang->line('Red. Stock') , $diferencia, 'format_price'); ?>
<?php endif; ?>
<?php echo _vs_end(); ?>
</div>
