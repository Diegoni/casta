...
summary="<?php echo $this->lang->line('Cálculo de comisiones');?> <?php echo $mes;?>-<?php echo $year;?>">
	...
	<thead>
		<tr class="HeaderStyle">
			...
			<th class="sortable" scope="col"><?php echo $this->lang->line('Idioma');?></th>
	...
	<tbody>
		...
		<tr <?php if ($odd):?> class="alt" <?php endif;?>>
			...
			<td align="left"><?php if (isset($valor['cNombre'])): ?>
				<?php echo $valor['cNombre'];?>
			<?php else: ?>
			<?php echo format_enlace_cmd($this->lang->line('[sin idioma]'), site_url('eoi/escuela/sin_idioma/' .
			$mes . '/' . $year . '/' . $valor['nIdEOI']));?>	
			<?php endif; ?>
			</td>
