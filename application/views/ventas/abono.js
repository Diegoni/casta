(function(){
    try {
		...
		var usado = new Ext.form.NumberField({
            xtype: 'numberfield',
			fieldLabel: _s('fUsado'),
            name: 'fUsado',
            width: 50,
            value: 0,
            allowNegative: false,
        ...
        // Controles normales
        var controls = [cliente, refs, importe, usado, {
                xtype: 'checkbox',
                id: 'bNoCaduca',
                // anchor : '90%',
                allowBlank: true,
                fieldLabel: _s('bNoCaduca')
            }, msg];
        ...
        var fn_open = function(id){
         ...
         <?php echo 'var grid_search = ' . extjs_creategrid($modelo, $id.'_g_search', null, null, 'ventas.abono', $this->reg->get_id(), null, FALSE, null, 'mode:"search", fn_open: fn_open');?>;
        ...
        var fn_enviar = function(){
            documentosEnviar(form, _s('Enviar'), site_url('ventas/abono/send'));
        }
