...
break;default:var t=Ext.getDom(this.msgTarget);if(t!=null){t.innerHTML='';t.style.display='none';}
break;}
...
this.clearInvalid();return true;},manageNameAttribute:function(){if(this.el!=null){if(this.items.getCount()===0&&this.forceFormValue){this.el.dom.setAttribute('name',this.hiddenName||this.name);}
