...
.createDelegate(this));
            ...
            this.ed.onPostRender.add(function(ed, controlManager){
                ...
                Ext.Element.fly(s.content_editable ? ed.getBody() : ed.getWin()).on("focus", this.onFocus, this);
                
                // Event of blur body
                Ext.Element.fly(s.content_editable ? ed.getBody() : ed.getWin()).on("blur", this.onBlur, this, this.inEditor && Ext.isWindows && Ext.isGecko ? {
                    buffer: 10
                } : null);
...
.createDelegate(this));
        ...
        _setEditorSize: function(width, height){
            ...
            var edTable = Ext.get(this.ed.id + "_tbl"), edIframe = Ext.get(this.ed.id + "_ifr"), edToolbar = Ext.get(this.ed.id + "_xtbar");
