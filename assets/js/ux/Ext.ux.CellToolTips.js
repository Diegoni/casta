//http://www.sencha.com/forum/showthread.php?59895-Ext.ux.plugins.grid.CellToolTips&highlight=Ext.ux.plugins.grid.CellToolTips
 ...
 * @constructor
 */
Ext.ux.CellToolTips = function(config){
    var cfgTips;
    ...
    Ext.ux.CellToolTips.superclass.constructor.call(this, config);
    if (config.tipConfig) {
...
// plugin code
Ext.extend(Ext.ux.CellToolTips, Ext.util.Observable, {
    version: 1.1,
    /**
     ...
     * @param {Ext.ux.CellToolTips} ctt The CellToolTips object
