<?php
	...
	$mcImageManagerConfig['general.language'] = "es"; // en, sv
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = ''; #'c:/xampp/htdocs/bp50/assets/js/tiny_mce/plugins/imagemanager'; // absolute or relative from this script path, try to leave blank system figures it out.
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../system/upload/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "loggedin";
