<?php /* Smarty version Smarty-3.1.19, created on 2015-03-20 06:40:14
         compiled from "/var/www/casta/themes/default-bootstrap/order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1955539120550beafe06b0e3-78850627%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b15d34e231834c52104b2e287b801fa200ebd2e' => 
    array (
      0 => '/var/www/casta/themes/default-bootstrap/order-steps.tpl',
      1 => 1426844226,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1955539120550beafe06b0e3-78850627',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_550beafe288d07_76271187',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_550beafe288d07_76271187')) {function content_550beafe288d07_76271187($_smarty_tpl) {?>
...
">
	...
	<li class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> four">
		...
		<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['multi_shipping']->value) {?><?php echo "&multi-shipping=";?><?php echo (string)$_smarty_tpl->tpl_vars['multi_shipping']->value;?><?php }?><?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,((string)Smarty::$_smarty_vars['capture']['url_back'])."&step=2".$_tmp4), ENT_QUOTES, 'UTF-8', true);?>
">
