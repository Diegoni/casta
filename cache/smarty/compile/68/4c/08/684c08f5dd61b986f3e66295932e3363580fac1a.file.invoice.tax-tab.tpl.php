<?php /* Smarty version Smarty-3.1.19, created on 2015-05-14 09:43:35
         compiled from "C:\xampp2\htdocs\casta\pdf\\invoice.tax-tab.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1344555549877621ea6-80312764%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '684c08f5dd61b986f3e66295932e3363580fac1a' => 
    array (
      0 => 'C:\\xampp2\\htdocs\\casta\\pdf\\\\invoice.tax-tab.tpl',
      1 => 1424703476,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1344555549877621ea6-80312764',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_555498777529f9_28059125',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555498777529f9_28059125')) {function content_555498777529f9_28059125($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:\\xampp2\\htdocs\\casta\\tools\\smarty\\plugins\\function.cycle.php';
?>

<?php if ($_smarty_tpl->tpl_vars['tax_exempt']->value||((isset($_smarty_tpl->tpl_vars['product_tax_breakdown']->value)&&count($_smarty_tpl->tpl_vars['product_tax_breakdown']->value)>0)||(isset($_smarty_tpl->tpl_vars['ecotax_tax_breakdown']->value)&&count($_smarty_tpl->tpl_vars['ecotax_tax_breakdown']->value)>0)||(isset($_smarty_tpl->tpl_vars['shipping_tax_breakdown']->value)&&count($_smarty_tpl->tpl_vars['shipping_tax_breakdown']->value)>0))) {?>
<!--  TAX DETAILS -->
		...
		<td style="width: 60%">
			...
			<table>
				<tr style="line-height:5px;">
					<td style="text-align: left; background-color: #4D4D4D; color: #FFF; padding-left: 10px; font-weight: bold; width: <?php if (!$_smarty_tpl->tpl_vars['use_one_after_another_method']->value) {?>30%<?php } else { ?>60%<?php }?>"><?php echo smartyTranslate(array('s'=>'Tax Detail','pdf'=>'true'),$_smarty_tpl);?>
</td>
					...
					<?php if (!$_smarty_tpl->tpl_vars['use_one_after_another_method']->value) {?>
						<td style="text-align: right; background-color: #4D4D4D; color: #FFF; padding-left: 10px; font-weight: bold; width: 30%"><?php echo smartyTranslate(array('s'=>'Total (Tax Excl.)','pdf'=>'true'),$_smarty_tpl);?>
</td>
					<?php }?>
...
;">
						 <td style="width: <?php if (!$_smarty_tpl->tpl_vars['use_one_after_another_method']->value) {?>30%<?php } else { ?>60%<?php }?>">
...
?>
						...
						<tr style="line-height:6px;background-color:<?php echo smarty_function_cycle(array('values'=>'#FFF,#DDD'),$_smarty_tpl);?>
;">
							<td style="width: <?php if (!$_smarty_tpl->tpl_vars['use_one_after_another_method']->value) {?>30%<?php } else { ?>60%<?php }?>"><?php echo smartyTranslate(array('s'=>'Ecotax','pdf'=>'true'),$_smarty_tpl);?>
</td>
