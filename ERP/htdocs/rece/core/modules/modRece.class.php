 ...
 */
class modRece extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "Conexión con el sistema RECE de la afip";
		...
		$this->config_page_url = array("config.php@rece");
