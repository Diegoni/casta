...
try {
	...
	$Certificado	= "nosotros.crt"; // certificado de prueba
	$ClavePrivada	= "nosotros.key"; // clave privada de prueba
	...
	echo "<hr>";
	echo "Fecha $fecha <br>";
	echo "Resultado = $WSFEv1->Resultado <br>";
	echo "Nro CBTE = $WSFEv1->CbteNro <br>";
	echo "CAE = $cae <br>";
	echo "Vencimiento $WSFEv1->Vencimiento <br>"; # Fecha de vto. de la autorizaci�n
	echo "Tipo Emision = $WSFEv1->EmisionTipo<br>";	
	echo "Reproceso = $WSFEv1->Reproceso<br>";
	echo "Errores = $WSFEv1->ErrMsg<br>";
	...
	{
		echo "No se asign� CAE (Rechazado). Motivos: $WSFEv1->Motivo <br>";
	}
	else
	if ($WSFEv1->Obs!="") 
	{
		echo "Se asign� CAE pero con advertencias. Motivos: $WSFEv1->Obs <br>";
	} 
...
catch (Exception $e) 
{
	...
	if (isset($WSAA)) 
	{
	    echo "WSAA.Excepcion: $WSAA->Excepcion <br>";
	    echo "WSAA.Traceback: $WSAA->Traceback <br>";
	}
	if (isset($WSFEv1)) 
	{
	    echo "WSFEv1.Excepcion: $WSFEv1->Excepcion <br>";
	    echo "WSFEv1.Traceback: $WSFEv1->Traceback <br>";
	}
}
if (isset($WSFEv1)) 
{
