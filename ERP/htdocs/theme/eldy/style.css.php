...
print '*/'."\n";
//TMS: cambio de tamaño de letra
if (! empty($conf->dol_optimize_smallscreen)) $fontsize=12;

$colortexttitle			= 'e7edf0';
$colorbacktitle1		= '18, 77, 111';
$colorbackhmenu1		= '18, 77, 111';
$colortextbackvmenu		= 'c3c5ca';
$colortextbackvmenuh	= 'f3f3f4';
?>
...
a.vmenu:link, a.vmenu:visited { 
	color: #<?php echo $colortextbackvmenuh; ?>; 
}
...
a.vsmenu:link:hover, a.vsmenu:visited:hover{ 
	color: #<?php echo $colortextbackvmenuh; ?>; 
	 text-decoration: none
}
...
<?php if ($usecss3) { ?>
	...
	/* TMS: cambio del menú parte izquierda
