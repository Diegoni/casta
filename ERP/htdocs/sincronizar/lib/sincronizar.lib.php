...
function paypaladmin_prepare_head()
{
	...
	$head[$h][0] = DOL_URL_ROOT."/sincronizar/admin/config.php";
	$head[$h][1] = 'Config';
	$head[$h][2] = 'config';
	$h++;
	
	$head[$h][0] = DOL_URL_ROOT.'/sincronizar/admin/clientes.php';
	$head[$h][1] = 'Clientes';
	$head[$h][2] = 'clientes';
	$h++;
	
	$head[$h][0] = DOL_URL_ROOT.'/sincronizar/admin/productos.php';
	$head[$h][1] = 'Productos';
	$head[$h][2] = 'productos';
	$h++;
	
	$head[$h][0] = DOL_URL_ROOT.'/sincronizar/admin/pedidos.php';
	$head[$h][1] = 'Pedidos';
	$head[$h][2] = 'pedidos';
	$h++;
	
	$head[$h][0] = DOL_URL_ROOT.'/sincronizar/admin/pagos.php';
	$head[$h][1] = 'Pagos';
	$head[$h][2] = 'pagos';
	$h++;
