 ...
 */
class modSincronizar extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "Permite sincronizar ERP con carro de compras";
		...
		$this->config_page_url = array("config.php@sincronizar");
