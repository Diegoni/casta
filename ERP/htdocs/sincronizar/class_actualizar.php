...
class Actualizar extends CommonObject
{
	...
	------------------------------------------------------------------
	 		...
	 		Función para insertar la sincronización
	...
	------------------------------------------------------------------
	 		...
	 		Función para sincronizar paises
	...
	------------------------------------------------------------------
	 		...
	 		Función para concatenar el nombre
	 
	------------------------------------------------------------------
	----------------------------------------------------------------*/
	
	function armar_nombre($nombre, $apellido)
	{
		if(is_numeric($apellido))
		{
			$cantidad_nombre = $apellido;
			$return['nombre']	= '';
			$return['apellido'] = '';
			
			$array_nombre = explode(' ', $nombre);
			
			if($cantidad_nombre <= count($array_nombre) || $cantidad_nombre == 0)
			{
				$cantidad_nombre = count($array_nombre) - 1;
			}
			
			foreach ($array_nombre as $key => $value) 
			{
				if($cantidad_nombre > $key)
				{
					$return['nombre']	.= $value.' ';
				}
				else
		...
		else
		{
			...
			$return['nombre_cantidad']	= str_word_count($nombre);	
		}
	...
	------------------------------------------------------------------
	 		...
	 		Función para borrar log repetidos
	...
	------------------------------------------------------------------
	 		...
	 		Función para insert de errores
	...
	------------------------------------------------------------------
	 		...
	 		Función para reset las tablas mod
	...
	------------------------------------------------------------------
	 		...
	 		Función para ver las consultas a base de datos
