...
$carpeta_raiz = 'C:\\xampp2\htdocs\\pyafipws-master\\';
$carpeta_conf = 'C:\\xampp2\htdocs\\pyafipws-master\\conf\\';
...
$linea_python = "python ".$carpeta_raiz."rece1.py ".$carpeta_conf."rece.ini /json /ult 1 4000 ".$carpeta_conf."rece.ini /json /ult 1 4000";
echo "<hr>".$linea_python."<br><hr>"; 
exec($linea_python);
echo "<hr>".exec($linea_python)."<br><hr>";
...
echo "Proximo Numero: ", $cbte_nro, "<br>";
...
//$linea_python = "python ./rece1.py rece.ini /json";
$linea_python = "python  ".$carpeta_raiz."rece1.py ".$carpeta_conf."rece.ini /json";
echo "<hr>".$linea_python."<br><hr>"; 
exec($linea_python);
echo "<hr>".exec($linea_python)."<br><hr>";
...
echo "CAE OBTENIDO: ", $facturas[0]['cae'], "<br>";
echo "Observaciones: ", $facturas[0]['motivos_obs'], "<br>";
echo "Errores: ", $facturas[0]['err_msg'], "<br>";
...
//$linea_python = "python ./pyfepdf.py rece.ini --cargar --json";
$linea_python = "python ".$carpeta_raiz."pyfepdf.py ".$carpeta_conf."rece.ini --cargar --json";
echo "<hr>".$linea_python."<br><hr>"; 
exec($linea_python);
echo "<hr>".exec($linea_python)."<br><hr>";
