<?php
/*
 * @$Header: /var/cvsroot/pop3ml/Attic/viewmsg.php,v 1.1.2.20 2010/05/19 08:51:10 cvs Exp $
 */
/*  
    ...
    function BuildMlList() {
        ...
        if(!empty($MyPop3ml->userRequest) && $MyPop3ml->userRequest === true) {
            ...
            $query = "select listname,sublist,language from ".$MyPop3ml->mltable.
               " where (sublist regexp '(^|\\r|\\n)$user(\\n|\\r|$)' or digestsublist regexp '(^|\\r|\\n)$user(\\n|\\r|$)' or allowsublist regexp '(^|\\r|\\n)$user(\\n|\\r|$)' or modsublist regexp '(^|\\r|\\n)$user(\\n|\\r|$)') and (denysublist not regexp '(^|\\r|\\n)$user(\\n|\\r|$)')";
        } else {
